...
import { getDashboard, getUsers, blockUser, getOrders, getSingleOrder, updateStatus, getReturnRequests, returnRequestAction, 
    downloadSalesReport, getSalesReport} from "../controllers/admin/adminController.js";
import { getAdminLogin, logoutAdmin, loginAdmin } from "../controllers/authController.js";
import { notLoggedin, isAdmin } from "../middlewares/adminMiddleware.js";
import { uploadCategoryImage, resizeCategoryImage,uploadProductImages, resizeProductImages, uploadBannerImages, 
    resizeBannerImages } from "../middlewares/imageUploadMiddleware.js";
import { getNewCategory, addNewCategory, getCategories, getEditCategory, editCategory, desableCategory, offerAction } from "../controllers/admin/categoryController.js";
import { getProducts, getAddProduct, addNewProduct, productDelete, getEditProduct, editProduct, deleteSingleImage, 
    addSingleImage, 
    productOfferAction} from "../controllers/admin/productController.js";
import { addNewCoupon, couponAction, getAddCoupon, getCoupons, getEditCoupon, editCoupon } from "../controllers/admin/couponController.js";
import { addNewBanner, getAddNewBanner, getBanners, getEditBanner, editBanner, bannerAction, deleteBannerImage, 
    addBannerImage } from "../controllers/admin/bannerController.js";


const router = Router();

router.route('/')
.get(notLoggedin, getAdminLogin)
.post(loginAdmin);
...
router.patch('/product/add-image/:id',isAdmin, uploadProductImages, resizeProductImages, addSingleImage);



router.route('/orders/:page')
    .get(isAdmin, getOrders)
    .post(isAdmin, getOrders);
...
router.patch('/banner/add-image/:id', isAdmin, uploadBannerImages,resizeBannerImages, addBannerImage);
