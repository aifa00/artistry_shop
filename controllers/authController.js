        ...
        if (foundAdmin.isAdmin) {
          ...
          if (isMatch) {
            ...
            res.render("admin/login", {
              commonError: "Invalid username or password",
            });
          }
        } else {
...
export const registerUser = async (req, res, next) => {
  try {
    const { name, email, phone, password, confirmPassword, ref } = req.body;
    ...
    if (name && email && phone && password && confirmPassword) {
      ...
      res.render("user/auth/register", {
        commonError: "Please fill in all fields",
        ref,
      });
    }
  } catch (error) {
    ...
    if (email && password) {
      ...
      if (foundUser) {
        ...
        if (foundUser.blocked) {
          res.render("user/auth/login", {
            commonError: "Can't log in.This user is blocked",
          });
        } else {
